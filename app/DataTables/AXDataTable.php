...
class AXDataTable extends BaseDatable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addIndexColumn()
            ->addColumn('action', 'admin.ax._tableAction');
    }

    public function query(AX $model): Builder
    {
    ...
    protected function getColumns(): array
    {
        return [
            ...
            Column::make('name')->title(__('AX')),
            Column::make('cost')->title(__('Cost')),
            Column::make('priority')->title(__('Priority')),
            Column::make('estimate_editor')->title(__('Estimate Editor')),
            Column::make('estimate_QA')->title(__('Estimate QA')),
